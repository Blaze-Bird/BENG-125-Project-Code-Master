...
RAo=0.5;     %aortic valve resistance (mmHg/(liter/minute))
%The following value of Csa is approximate;
%needs adjustment to make blood pressure 120/80:
Csa=0.0014;  %Systemic arterial compliance (liters/mmHg)
CLVS=0.0003; %Min (systolic)  value of CLV (liters/mmHg)
CLVD=0.005;  %Max (diastolic) value of CLV (liters/mmHg)
Vsad=0.825;   %Systemic arterial volume when Psa=0 (liters)
VLVd=0.027;   %Left ventricular volume when PLV=0 (liters)
PLA=20;        %Left atrial pressure (mmHg)
